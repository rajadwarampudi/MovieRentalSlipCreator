...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String result = new RentalInformationGenerator().generateStatement(new Customer("C. U. Stomer", Arrays.asList(new MovieRentalInformation("F001", 3), new MovieRentalInformation("F002", 1))));
